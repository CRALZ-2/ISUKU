...
<aside class="sidebar">
  <div>
    ...
    <ul>
      ...
      <li><a href="publication.php" class="<?= $currentPage == 'publication.php' ? 'active' : '' ?>">Publication</a></li>
      <li><a href="log_connexion.php" class="<?= $currentPage == 'log_connexion.php' ? 'active' : '' ?>">Sessions</a></li>
